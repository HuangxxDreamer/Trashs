...
func init() {
	typemap.RegisterMessage("realsense2_camera_msgs/TriggeredCalibration_Feedback", TriggeredCalibration_FeedbackTypeSupport)
	typemap.RegisterMessage("realsense2_camera_msgs/action/TriggeredCalibration_Feedback", TriggeredCalibration_FeedbackTypeSupport)
}
...
func (t *TriggeredCalibration_Feedback) CloneMsg() types.Message {
	return t.Clone()
}
...
func (t *TriggeredCalibration_Feedback) GetTypeSupport() types.MessageTypeSupport {
	return TriggeredCalibration_FeedbackTypeSupport
}

// TriggeredCalibration_FeedbackPublisher wraps rclgo.Publisher to provide type safe helper
// functions
...
func NewTriggeredCalibration_FeedbackPublisher(node *rclgo.Node, topic_name string, options *rclgo.PublisherOptions) (*TriggeredCalibration_FeedbackPublisher, error) {
	pub, err := node.NewPublisher(topic_name, TriggeredCalibration_FeedbackTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
// TriggeredCalibration_FeedbackSubscription wraps rclgo.Subscription to provide type safe helper
// functions
...
type TriggeredCalibration_FeedbackSubscriptionCallback func(msg *TriggeredCalibration_Feedback, info *rclgo.MessageInfo, err error)

// NewTriggeredCalibration_FeedbackSubscription creates and returns a new subscription for the
// TriggeredCalibration_Feedback
func NewTriggeredCalibration_FeedbackSubscription(node *rclgo.Node, topic_name string, opts *rclgo.SubscriptionOptions, subscriptionCallback TriggeredCalibration_FeedbackSubscriptionCallback) (*TriggeredCalibration_FeedbackSubscription, error) {
	callback := func(s *rclgo.Subscription) {
		var msg TriggeredCalibration_Feedback
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topic_name, TriggeredCalibration_FeedbackTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
func (s *TriggeredCalibration_FeedbackSubscription) TakeMessage(out *TriggeredCalibration_Feedback) (*rclgo.MessageInfo, error) {
...
var TriggeredCalibration_FeedbackTypeSupport types.MessageTypeSupport = _TriggeredCalibration_FeedbackTypeSupport{}

type _TriggeredCalibration_FeedbackTypeSupport struct{}

func (t _TriggeredCalibration_FeedbackTypeSupport) New() types.Message {
...
func (t _TriggeredCalibration_FeedbackTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
...
func (t _TriggeredCalibration_FeedbackTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*TriggeredCalibration_Feedback)
...
type CTriggeredCalibration_Feedback__Sequence = C.realsense2_camera_msgs__action__TriggeredCalibration_Feedback__Sequence

func TriggeredCalibration_Feedback__Sequence_to_Go(goSlice *[]TriggeredCalibration_Feedback, cSlice CTriggeredCalibration_Feedback__Sequence) {
	if cSlice.size == 0 {
		return
	}
...
func TriggeredCalibration_Feedback__Sequence_to_C(cSlice *CTriggeredCalibration_Feedback__Sequence, goSlice []TriggeredCalibration_Feedback) {
	if len(goSlice) == 0 {
		cSlice.data = nil
		cSlice.capacity = 0
		cSlice.size = 0
...
func TriggeredCalibration_Feedback__Array_to_Go(goSlice []TriggeredCalibration_Feedback, cSlice []CTriggeredCalibration_Feedback) {
	for i := 0; i < len(cSlice); i++ {
		TriggeredCalibration_FeedbackTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}
func TriggeredCalibration_Feedback__Array_to_C(cSlice []CTriggeredCalibration_Feedback, goSlice []TriggeredCalibration_Feedback) {
