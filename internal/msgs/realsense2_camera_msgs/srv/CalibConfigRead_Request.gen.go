...
func init() {
	typemap.RegisterMessage("realsense2_camera_msgs/CalibConfigRead_Request", CalibConfigRead_RequestTypeSupport)
	typemap.RegisterMessage("realsense2_camera_msgs/srv/CalibConfigRead_Request", CalibConfigRead_RequestTypeSupport)
}
...
func (t *CalibConfigRead_Request) CloneMsg() types.Message {
	return t.Clone()
}
...
func (t *CalibConfigRead_Request) GetTypeSupport() types.MessageTypeSupport {
	return CalibConfigRead_RequestTypeSupport
}

// CalibConfigRead_RequestPublisher wraps rclgo.Publisher to provide type safe helper
// functions
...
func NewCalibConfigRead_RequestPublisher(node *rclgo.Node, topic_name string, options *rclgo.PublisherOptions) (*CalibConfigRead_RequestPublisher, error) {
	pub, err := node.NewPublisher(topic_name, CalibConfigRead_RequestTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
// CalibConfigRead_RequestSubscription wraps rclgo.Subscription to provide type safe helper
// functions
...
type CalibConfigRead_RequestSubscriptionCallback func(msg *CalibConfigRead_Request, info *rclgo.MessageInfo, err error)

// NewCalibConfigRead_RequestSubscription creates and returns a new subscription for the
// CalibConfigRead_Request
func NewCalibConfigRead_RequestSubscription(node *rclgo.Node, topic_name string, opts *rclgo.SubscriptionOptions, subscriptionCallback CalibConfigRead_RequestSubscriptionCallback) (*CalibConfigRead_RequestSubscription, error) {
	callback := func(s *rclgo.Subscription) {
		var msg CalibConfigRead_Request
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topic_name, CalibConfigRead_RequestTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
func (s *CalibConfigRead_RequestSubscription) TakeMessage(out *CalibConfigRead_Request) (*rclgo.MessageInfo, error) {
...
var CalibConfigRead_RequestTypeSupport types.MessageTypeSupport = _CalibConfigRead_RequestTypeSupport{}

type _CalibConfigRead_RequestTypeSupport struct{}

func (t _CalibConfigRead_RequestTypeSupport) New() types.Message {
...
func (t _CalibConfigRead_RequestTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	
}

func (t _CalibConfigRead_RequestTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
...
type CCalibConfigRead_Request__Sequence = C.realsense2_camera_msgs__srv__CalibConfigRead_Request__Sequence

func CalibConfigRead_Request__Sequence_to_Go(goSlice *[]CalibConfigRead_Request, cSlice CCalibConfigRead_Request__Sequence) {
	if cSlice.size == 0 {
		return
	}
...
func CalibConfigRead_Request__Sequence_to_C(cSlice *CCalibConfigRead_Request__Sequence, goSlice []CalibConfigRead_Request) {
	if len(goSlice) == 0 {
		cSlice.data = nil
		cSlice.capacity = 0
		cSlice.size = 0
...
func CalibConfigRead_Request__Array_to_Go(goSlice []CalibConfigRead_Request, cSlice []CCalibConfigRead_Request) {
	for i := 0; i < len(cSlice); i++ {
		CalibConfigRead_RequestTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}
func CalibConfigRead_Request__Array_to_C(cSlice []CCalibConfigRead_Request, goSlice []CalibConfigRead_Request) {
