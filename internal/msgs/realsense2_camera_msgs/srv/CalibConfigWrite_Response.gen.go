...
func init() {
	typemap.RegisterMessage("realsense2_camera_msgs/CalibConfigWrite_Response", CalibConfigWrite_ResponseTypeSupport)
	typemap.RegisterMessage("realsense2_camera_msgs/srv/CalibConfigWrite_Response", CalibConfigWrite_ResponseTypeSupport)
}
...
func (t *CalibConfigWrite_Response) CloneMsg() types.Message {
	return t.Clone()
}
...
func (t *CalibConfigWrite_Response) GetTypeSupport() types.MessageTypeSupport {
	return CalibConfigWrite_ResponseTypeSupport
}

// CalibConfigWrite_ResponsePublisher wraps rclgo.Publisher to provide type safe helper
// functions
...
func NewCalibConfigWrite_ResponsePublisher(node *rclgo.Node, topic_name string, options *rclgo.PublisherOptions) (*CalibConfigWrite_ResponsePublisher, error) {
	pub, err := node.NewPublisher(topic_name, CalibConfigWrite_ResponseTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
// CalibConfigWrite_ResponseSubscription wraps rclgo.Subscription to provide type safe helper
// functions
...
type CalibConfigWrite_ResponseSubscriptionCallback func(msg *CalibConfigWrite_Response, info *rclgo.MessageInfo, err error)

// NewCalibConfigWrite_ResponseSubscription creates and returns a new subscription for the
// CalibConfigWrite_Response
func NewCalibConfigWrite_ResponseSubscription(node *rclgo.Node, topic_name string, opts *rclgo.SubscriptionOptions, subscriptionCallback CalibConfigWrite_ResponseSubscriptionCallback) (*CalibConfigWrite_ResponseSubscription, error) {
	callback := func(s *rclgo.Subscription) {
		var msg CalibConfigWrite_Response
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topic_name, CalibConfigWrite_ResponseTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
func (s *CalibConfigWrite_ResponseSubscription) TakeMessage(out *CalibConfigWrite_Response) (*rclgo.MessageInfo, error) {
...
var CalibConfigWrite_ResponseTypeSupport types.MessageTypeSupport = _CalibConfigWrite_ResponseTypeSupport{}

type _CalibConfigWrite_ResponseTypeSupport struct{}

func (t _CalibConfigWrite_ResponseTypeSupport) New() types.Message {
...
func (t _CalibConfigWrite_ResponseTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
...
func (t _CalibConfigWrite_ResponseTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*CalibConfigWrite_Response)
...
type CCalibConfigWrite_Response__Sequence = C.realsense2_camera_msgs__srv__CalibConfigWrite_Response__Sequence

func CalibConfigWrite_Response__Sequence_to_Go(goSlice *[]CalibConfigWrite_Response, cSlice CCalibConfigWrite_Response__Sequence) {
	if cSlice.size == 0 {
		return
	}
...
func CalibConfigWrite_Response__Sequence_to_C(cSlice *CCalibConfigWrite_Response__Sequence, goSlice []CalibConfigWrite_Response) {
	if len(goSlice) == 0 {
		cSlice.data = nil
		cSlice.capacity = 0
		cSlice.size = 0
...
func CalibConfigWrite_Response__Array_to_Go(goSlice []CalibConfigWrite_Response, cSlice []CCalibConfigWrite_Response) {
	for i := 0; i < len(cSlice); i++ {
		CalibConfigWrite_ResponseTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}
func CalibConfigWrite_Response__Array_to_C(cSlice []CCalibConfigWrite_Response, goSlice []CalibConfigWrite_Response) {
