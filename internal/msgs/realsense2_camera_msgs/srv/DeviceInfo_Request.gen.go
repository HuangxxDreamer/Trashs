...
func init() {
	typemap.RegisterMessage("realsense2_camera_msgs/DeviceInfo_Request", DeviceInfo_RequestTypeSupport)
	typemap.RegisterMessage("realsense2_camera_msgs/srv/DeviceInfo_Request", DeviceInfo_RequestTypeSupport)
}
...
func (t *DeviceInfo_Request) CloneMsg() types.Message {
	return t.Clone()
}
...
func (t *DeviceInfo_Request) GetTypeSupport() types.MessageTypeSupport {
	return DeviceInfo_RequestTypeSupport
}

// DeviceInfo_RequestPublisher wraps rclgo.Publisher to provide type safe helper
// functions
...
// DeviceInfo_Request
func NewDeviceInfo_RequestPublisher(node *rclgo.Node, topic_name string, options *rclgo.PublisherOptions) (*DeviceInfo_RequestPublisher, error) {
	pub, err := node.NewPublisher(topic_name, DeviceInfo_RequestTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
// DeviceInfo_RequestSubscription wraps rclgo.Subscription to provide type safe helper
// functions
...
type DeviceInfo_RequestSubscriptionCallback func(msg *DeviceInfo_Request, info *rclgo.MessageInfo, err error)

// NewDeviceInfo_RequestSubscription creates and returns a new subscription for the
// DeviceInfo_Request
func NewDeviceInfo_RequestSubscription(node *rclgo.Node, topic_name string, opts *rclgo.SubscriptionOptions, subscriptionCallback DeviceInfo_RequestSubscriptionCallback) (*DeviceInfo_RequestSubscription, error) {
	callback := func(s *rclgo.Subscription) {
		var msg DeviceInfo_Request
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topic_name, DeviceInfo_RequestTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
func (s *DeviceInfo_RequestSubscription) TakeMessage(out *DeviceInfo_Request) (*rclgo.MessageInfo, error) {
...
var DeviceInfo_RequestTypeSupport types.MessageTypeSupport = _DeviceInfo_RequestTypeSupport{}

type _DeviceInfo_RequestTypeSupport struct{}

func (t _DeviceInfo_RequestTypeSupport) New() types.Message {
...
func (t _DeviceInfo_RequestTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	
}

func (t _DeviceInfo_RequestTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
...
type CDeviceInfo_Request__Sequence = C.realsense2_camera_msgs__srv__DeviceInfo_Request__Sequence

func DeviceInfo_Request__Sequence_to_Go(goSlice *[]DeviceInfo_Request, cSlice CDeviceInfo_Request__Sequence) {
	if cSlice.size == 0 {
		return
	}
...
func DeviceInfo_Request__Sequence_to_C(cSlice *CDeviceInfo_Request__Sequence, goSlice []DeviceInfo_Request) {
	if len(goSlice) == 0 {
		cSlice.data = nil
		cSlice.capacity = 0
		cSlice.size = 0
...
func DeviceInfo_Request__Array_to_Go(goSlice []DeviceInfo_Request, cSlice []CDeviceInfo_Request) {
	for i := 0; i < len(cSlice); i++ {
		DeviceInfo_RequestTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}
func DeviceInfo_Request__Array_to_C(cSlice []CDeviceInfo_Request, goSlice []DeviceInfo_Request) {
