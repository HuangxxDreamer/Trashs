...
func init() {
	typemap.RegisterService("rtabmap_msgs/GetMap", GetMapTypeSupport)
	typemap.RegisterService("rtabmap_msgs/srv/GetMap", GetMapTypeSupport)
}
...
func (s _GetMapTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_service_type_support_handle__rtabmap_msgs__srv__GetMap())
}
