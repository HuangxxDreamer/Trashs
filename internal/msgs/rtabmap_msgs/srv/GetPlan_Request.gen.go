...
func init() {
	typemap.RegisterMessage("rtabmap_msgs/GetPlan_Request", GetPlan_RequestTypeSupport)
	typemap.RegisterMessage("rtabmap_msgs/srv/GetPlan_Request", GetPlan_RequestTypeSupport)
}

type GetPlan_Request struct {
	GoalNode int32 `yaml:"goal_node"`// The final node of the goal (set 0 to use pose instead)
	Goal geometry_msgs_msg.PoseStamped `yaml:"goal"`// The final pose of the goal position (used only if goalNodeId=0)
	Tolerance float32 `yaml:"tolerance"`// How many meters from the map's graph we can plan (0=infinite)
}
...
func (t _GetPlan_RequestTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.rtabmap_msgs__srv__GetPlan_Request
	return (unsafe.Pointer)(C.rtabmap_msgs__srv__GetPlan_Request__create())
}

func (t _GetPlan_RequestTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.rtabmap_msgs__srv__GetPlan_Request__destroy((*C.rtabmap_msgs__srv__GetPlan_Request)(pointer_to_free))
}

func (t _GetPlan_RequestTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	m := msg.(*GetPlan_Request)
	mem := (*C.rtabmap_msgs__srv__GetPlan_Request)(dst)
	mem.goal_node = C.int32_t(m.GoalNode)
...
func (t _GetPlan_RequestTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*GetPlan_Request)
	mem := (*C.rtabmap_msgs__srv__GetPlan_Request)(ros2_message_buffer)
	m.GoalNode = int32(mem.goal_node)
...
func (t _GetPlan_RequestTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__rtabmap_msgs__srv__GetPlan_Request())
}

type CGetPlan_Request = C.rtabmap_msgs__srv__GetPlan_Request
type CGetPlan_Request__Sequence = C.rtabmap_msgs__srv__GetPlan_Request__Sequence
...
func GetPlan_Request__Sequence_to_C(cSlice *CGetPlan_Request__Sequence, goSlice []GetPlan_Request) {
	...
	cSlice.data = (*C.rtabmap_msgs__srv__GetPlan_Request)(C.malloc(C.sizeof_struct_rtabmap_msgs__srv__GetPlan_Request * C.size_t(len(goSlice))))
