...
func init() {
	typemap.RegisterService("rtabmap_msgs/GetPlan", GetPlanTypeSupport)
	typemap.RegisterService("rtabmap_msgs/srv/GetPlan", GetPlanTypeSupport)
}
...
func (s _GetPlanTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_service_type_support_handle__rtabmap_msgs__srv__GetPlan())
}
