...
func init() {
	typemap.RegisterMessage("rtabmap_msgs/Path", PathTypeSupport)
	typemap.RegisterMessage("rtabmap_msgs/msg/Path", PathTypeSupport)
}

type Path struct {
	Header std_msgs_msg.Header `yaml:"header"`
	NodeIds []int32 `yaml:"node_ids"`
...
func (t *Path) Clone() *Path {
	...
	if t.NodeIds != nil {
		c.NodeIds = make([]int32, len(t.NodeIds))
		copy(c.NodeIds, t.NodeIds)
	}
	if t.Poses != nil {
...
func (t _PathTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.rtabmap_msgs__msg__Path
	return (unsafe.Pointer)(C.rtabmap_msgs__msg__Path__create())
}

func (t _PathTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.rtabmap_msgs__msg__Path__destroy((*C.rtabmap_msgs__msg__Path)(pointer_to_free))
}

func (t _PathTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	m := msg.(*Path)
	mem := (*C.rtabmap_msgs__msg__Path)(dst)
	std_msgs_msg.HeaderTypeSupport.AsCStruct(unsafe.Pointer(&mem.header), &m.Header)
	primitives.Int32__Sequence_to_C((*primitives.CInt32__Sequence)(unsafe.Pointer(&mem.node_ids)), m.NodeIds)
...
func (t _PathTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Path)
	mem := (*C.rtabmap_msgs__msg__Path)(ros2_message_buffer)
	std_msgs_msg.HeaderTypeSupport.AsGoStruct(&m.Header, unsafe.Pointer(&mem.header))
	primitives.Int32__Sequence_to_Go(&m.NodeIds, *(*primitives.CInt32__Sequence)(unsafe.Pointer(&mem.node_ids)))
...
func (t _PathTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__rtabmap_msgs__msg__Path())
}

type CPath = C.rtabmap_msgs__msg__Path
type CPath__Sequence = C.rtabmap_msgs__msg__Path__Sequence
...
func Path__Sequence_to_C(cSlice *CPath__Sequence, goSlice []Path) {
	...
	cSlice.data = (*C.rtabmap_msgs__msg__Path)(C.malloc(C.sizeof_struct_rtabmap_msgs__msg__Path * C.size_t(len(goSlice))))
