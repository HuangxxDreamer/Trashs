...
func init() {
	typemap.RegisterService("slam_toolbox/Pause", PauseTypeSupport)
	typemap.RegisterService("slam_toolbox/srv/Pause", PauseTypeSupport)
}
...
func (s _PauseTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_service_type_support_handle__slam_toolbox__srv__Pause())
}
