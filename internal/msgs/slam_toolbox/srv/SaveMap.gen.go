...
func init() {
	typemap.RegisterService("slam_toolbox/SaveMap", SaveMapTypeSupport)
	typemap.RegisterService("slam_toolbox/srv/SaveMap", SaveMapTypeSupport)
}
...
func (s _SaveMapTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_service_type_support_handle__slam_toolbox__srv__SaveMap())
}
