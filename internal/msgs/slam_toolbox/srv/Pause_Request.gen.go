...
func init() {
	typemap.RegisterMessage("slam_toolbox/Pause_Request", Pause_RequestTypeSupport)
	typemap.RegisterMessage("slam_toolbox/srv/Pause_Request", Pause_RequestTypeSupport)
}
...
func (t _Pause_RequestTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.slam_toolbox__srv__Pause_Request
	return (unsafe.Pointer)(C.slam_toolbox__srv__Pause_Request__create())
}

func (t _Pause_RequestTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.slam_toolbox__srv__Pause_Request__destroy((*C.slam_toolbox__srv__Pause_Request)(pointer_to_free))
}
...
func (t _Pause_RequestTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__slam_toolbox__srv__Pause_Request())
}

type CPause_Request = C.slam_toolbox__srv__Pause_Request
type CPause_Request__Sequence = C.slam_toolbox__srv__Pause_Request__Sequence
...
func Pause_Request__Sequence_to_C(cSlice *CPause_Request__Sequence, goSlice []Pause_Request) {
	...
	cSlice.data = (*C.slam_toolbox__srv__Pause_Request)(C.malloc(C.sizeof_struct_slam_toolbox__srv__Pause_Request * C.size_t(len(goSlice))))
