...
func init() {
	typemap.RegisterMessage("slam_toolbox/SaveMap_Request", SaveMap_RequestTypeSupport)
	typemap.RegisterMessage("slam_toolbox/srv/SaveMap_Request", SaveMap_RequestTypeSupport)
}

type SaveMap_Request struct {
	Name std_msgs_msg.String `yaml:"name"`
}
...
func (t _SaveMap_RequestTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.slam_toolbox__srv__SaveMap_Request
	return (unsafe.Pointer)(C.slam_toolbox__srv__SaveMap_Request__create())
}

func (t _SaveMap_RequestTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.slam_toolbox__srv__SaveMap_Request__destroy((*C.slam_toolbox__srv__SaveMap_Request)(pointer_to_free))
}

func (t _SaveMap_RequestTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	m := msg.(*SaveMap_Request)
	mem := (*C.slam_toolbox__srv__SaveMap_Request)(dst)
	std_msgs_msg.StringTypeSupport.AsCStruct(unsafe.Pointer(&mem.name), &m.Name)
}

func (t _SaveMap_RequestTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*SaveMap_Request)
	mem := (*C.slam_toolbox__srv__SaveMap_Request)(ros2_message_buffer)
	std_msgs_msg.StringTypeSupport.AsGoStruct(&m.Name, unsafe.Pointer(&mem.name))
}

func (t _SaveMap_RequestTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__slam_toolbox__srv__SaveMap_Request())
}

type CSaveMap_Request = C.slam_toolbox__srv__SaveMap_Request
type CSaveMap_Request__Sequence = C.slam_toolbox__srv__SaveMap_Request__Sequence
...
func SaveMap_Request__Sequence_to_C(cSlice *CSaveMap_Request__Sequence, goSlice []SaveMap_Request) {
	...
	cSlice.data = (*C.slam_toolbox__srv__SaveMap_Request)(C.malloc(C.sizeof_struct_slam_toolbox__srv__SaveMap_Request * C.size_t(len(goSlice))))
