...
func init() {
	typemap.RegisterMessage("slam_toolbox/Pause_Response", Pause_ResponseTypeSupport)
	typemap.RegisterMessage("slam_toolbox/srv/Pause_Response", Pause_ResponseTypeSupport)
}
...
func (t _Pause_ResponseTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.slam_toolbox__srv__Pause_Response
	return (unsafe.Pointer)(C.slam_toolbox__srv__Pause_Response__create())
}

func (t _Pause_ResponseTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.slam_toolbox__srv__Pause_Response__destroy((*C.slam_toolbox__srv__Pause_Response)(pointer_to_free))
}

func (t _Pause_ResponseTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	m := msg.(*Pause_Response)
	mem := (*C.slam_toolbox__srv__Pause_Response)(dst)
...
func (t _Pause_ResponseTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Pause_Response)
	mem := (*C.slam_toolbox__srv__Pause_Response)(ros2_message_buffer)
	m.Status = bool(mem.status)
}

func (t _Pause_ResponseTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__slam_toolbox__srv__Pause_Response())
}

type CPause_Response = C.slam_toolbox__srv__Pause_Response
type CPause_Response__Sequence = C.slam_toolbox__srv__Pause_Response__Sequence
...
func Pause_Response__Sequence_to_C(cSlice *CPause_Response__Sequence, goSlice []Pause_Response) {
	...
	cSlice.data = (*C.slam_toolbox__srv__Pause_Response)(C.malloc(C.sizeof_struct_slam_toolbox__srv__Pause_Response * C.size_t(len(goSlice))))
