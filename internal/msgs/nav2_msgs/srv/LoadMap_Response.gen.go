...
func init() {
	typemap.RegisterMessage("nav2_msgs/LoadMap_Response", LoadMap_ResponseTypeSupport)
	typemap.RegisterMessage("nav2_msgs/srv/LoadMap_Response", LoadMap_ResponseTypeSupport)
}
const (
...
func (t _LoadMap_ResponseTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.nav2_msgs__srv__LoadMap_Response
	return (unsafe.Pointer)(C.nav2_msgs__srv__LoadMap_Response__create())
}

func (t _LoadMap_ResponseTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.nav2_msgs__srv__LoadMap_Response__destroy((*C.nav2_msgs__srv__LoadMap_Response)(pointer_to_free))
}

func (t _LoadMap_ResponseTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	m := msg.(*LoadMap_Response)
	mem := (*C.nav2_msgs__srv__LoadMap_Response)(dst)
...
func (t _LoadMap_ResponseTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*LoadMap_Response)
	mem := (*C.nav2_msgs__srv__LoadMap_Response)(ros2_message_buffer)
...
func (t _LoadMap_ResponseTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__nav2_msgs__srv__LoadMap_Response())
}

type CLoadMap_Response = C.nav2_msgs__srv__LoadMap_Response
type CLoadMap_Response__Sequence = C.nav2_msgs__srv__LoadMap_Response__Sequence
...
func LoadMap_Response__Sequence_to_C(cSlice *CLoadMap_Response__Sequence, goSlice []LoadMap_Response) {
	...
	cSlice.data = (*C.nav2_msgs__srv__LoadMap_Response)(C.malloc(C.sizeof_struct_nav2_msgs__srv__LoadMap_Response * C.size_t(len(goSlice))))
