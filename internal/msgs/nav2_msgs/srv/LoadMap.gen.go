...
func init() {
	typemap.RegisterService("nav2_msgs/LoadMap", LoadMapTypeSupport)
	typemap.RegisterService("nav2_msgs/srv/LoadMap", LoadMapTypeSupport)
}
...
func (s _LoadMapTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_service_type_support_handle__nav2_msgs__srv__LoadMap())
}
