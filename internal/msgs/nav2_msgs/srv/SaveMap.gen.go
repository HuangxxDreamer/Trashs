...
func init() {
	typemap.RegisterService("nav2_msgs/SaveMap", SaveMapTypeSupport)
	typemap.RegisterService("nav2_msgs/srv/SaveMap", SaveMapTypeSupport)
}
...
func (s _SaveMapTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_service_type_support_handle__nav2_msgs__srv__SaveMap())
}
