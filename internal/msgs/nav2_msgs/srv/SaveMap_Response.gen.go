...
func init() {
	typemap.RegisterMessage("nav2_msgs/SaveMap_Response", SaveMap_ResponseTypeSupport)
	typemap.RegisterMessage("nav2_msgs/srv/SaveMap_Response", SaveMap_ResponseTypeSupport)
}
...
func (t _SaveMap_ResponseTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.nav2_msgs__srv__SaveMap_Response
	return (unsafe.Pointer)(C.nav2_msgs__srv__SaveMap_Response__create())
}

func (t _SaveMap_ResponseTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.nav2_msgs__srv__SaveMap_Response__destroy((*C.nav2_msgs__srv__SaveMap_Response)(pointer_to_free))
}

func (t _SaveMap_ResponseTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	m := msg.(*SaveMap_Response)
	mem := (*C.nav2_msgs__srv__SaveMap_Response)(dst)
	mem.result = C.bool(m.Result)
}

func (t _SaveMap_ResponseTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*SaveMap_Response)
	mem := (*C.nav2_msgs__srv__SaveMap_Response)(ros2_message_buffer)
	m.Result = bool(mem.result)
}

func (t _SaveMap_ResponseTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__nav2_msgs__srv__SaveMap_Response())
}

type CSaveMap_Response = C.nav2_msgs__srv__SaveMap_Response
type CSaveMap_Response__Sequence = C.nav2_msgs__srv__SaveMap_Response__Sequence
...
func SaveMap_Response__Sequence_to_C(cSlice *CSaveMap_Response__Sequence, goSlice []SaveMap_Response) {
	...
	cSlice.data = (*C.nav2_msgs__srv__SaveMap_Response)(C.malloc(C.sizeof_struct_nav2_msgs__srv__SaveMap_Response * C.size_t(len(goSlice))))
